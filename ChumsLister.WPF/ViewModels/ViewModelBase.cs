// File: ChumsLister.WPF/ViewModels/ViewModelBase.cs
using System;
...
namespace ChumsLister.WPF.ViewModels
{
    ...
    public class RelayCommand<T> : ICommand
    {
        ...
        public bool CanExecute(object? parameter) =>
            _canExecute == null || _canExecute(parameter == null ? default : (T)parameter);
    ...
    // Simple RelayCommand for compatibility with existing code
